...
import minigamemanager.api.rotation.SubstitutionHandler;
import minigamemanager.commands.CommandJoin;
import minigamemanager.commands.CommandLeave;
import minigamemanager.commands.CommandLocation;
import minigamemanager.commands.CommandMinigame;
...
import minigamemanager.listeners.JoinQuitListener;
import minigamemanager.listeners.MinigameListener;
import minigamemanager.rotations.DefaultRotationManager;
	...
	public void loadDefaultMinigames() {
		if (manager.config.defaultsEnabled()) {
			...
			for (String minigameStr : manager.config.getDefaultMinigames()) {
				Class<?> clazz = null;
				try {
					// all default minigames MUST be in the .minigamemanager.minigames package
					clazz = Class.forName("minigamemanager.minigames." + minigameStr.replace("_", ""));
